            ...
            <View style={styles.formContainer}>
                ...
                {/* <View style={{top: 20, display: 'flex', gap: 20, width: '100%', alignItems: 'center' }}>
                    <TouchableOpacity 
                        style={styles.formButton}
                    >
                        <Text style={{ color: colors.background, textAlign: 'center' }} onPress={() => navigation.navigate('AddMedicine')} >Adicionar medicamento</Text>
                    </TouchableOpacity>
                </View> */}
                {/* Dupliquei o button pra acessar e visualizar a tela de adicionar o medicamento. Tirem esse comentário do código e testem. Assim que visualizarem e testarem, eu retirarei esse segundo button. */}
            </View>
